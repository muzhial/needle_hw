...
class Op:
    ...
    def gradient(self, out_grad: 'Value',
        ...
        """Compute partial adjoint for each input value for a given output
        adjoint.
...
class TensorOp(Op):
    """Op class specialized to output tensors, will be alterate subclasses for
    other structures."""
...
class TensorTuple(Value):
    ...
    def detach(self):
        """Create a new tensor that shares the data but detaches from the
        graph."""
...
def find_topo_sort(node_list: List[Value]) -> List[Value]:
    """Given a list of nodes, return a topological sort list of nodes ending in
    them.
...
def sum_node_list(node_list):
    """Custom sum function in order to avoid create redundant nodes in Python
    sum implementation."""
